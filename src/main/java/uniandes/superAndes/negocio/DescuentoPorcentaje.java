...
public class DescuentoPorcentaje extends Promocion implements VODescuentoPorcentaje{
	 ...
	 */
	public DescuentoPorcentaje(long id, Date fechaInicial, Date fechaFinal, double precio, double porcentaje, long idDescuentoPorcentaje, Long idProducto) {
		super(id, fechaInicial, fechaFinal, precio,idDescuentoPorcentaje, null,null,null, idProducto);
